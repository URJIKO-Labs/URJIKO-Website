...
export const featuredProjects = [
  {
    ...
    businessValue: [
      ...
      "Better organization of daily operations",
      "Easier sales and inventory monitoring",
      "Clearer reporting and business insights",
  ...
  },
  {
    ...
    businessValue: [
      ...
      "Better visibility into transport activities",
  ...
  },
  {
    ...
    businessValue: [
      ...
      "Easier student and teacher monitoring",
      "Structured academic workflows",
      "Improved visibility for school leaders",
    ],
    technologies: [
      "React",
      "JavaScript",
  ...
  },
  {
    ...
    description:
      "A digital healthcare platform concept focused on structured workflows, management dashboards, and administrative tools for healthcare organizations.",
    problem:
    ...
    disclaimer:
      "ShegerHealth is a demonstration project exploring digital healthcare workflows. It is not a certified medical system.",
    layout: "right",
  },
];
