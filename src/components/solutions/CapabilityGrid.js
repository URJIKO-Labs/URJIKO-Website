  ...
  const capabilities = [
    {
      ...
      description: 'Track products, stock levels, and availability',
    ...
    {
      title: 'Point of Sale',
      description: 'Process transactions and manage sales records',
    ...
    },
    {
      ...
      description: 'Organize contacts, accounts, and interactions',
      icon: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>`,
    },
    {
      title: 'Dashboards',
      description: 'Real-time operational visibility and metrics',
    ...
    {
      title: 'Reporting',
      description: 'Generate business intelligence and data exports',
    ...
    },
    {
      ...
      description: 'Control permissions by user role',
    ...
    },
    {
      ...
      description: 'Structured storage, queries, and data integrity',
    ...
    },
    {
      ...
      description: 'Manage appointments and resource allocation',
    ...
    },
    {
      ...
      description: 'Intelligent features and automation capabilities',
