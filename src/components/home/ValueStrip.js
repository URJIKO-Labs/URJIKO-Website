  ...
  const values = [
    {
      ...
      description:
        "Technology designed around real business problems and operational bottlenecks.",
    ...
    },
    {
      ...
      description:
        "Responsive, cross-platform experiences engineered for smooth use on any device.",
    ...
    },
    {
      ...
      description:
        "Built with security, high availability, and maintainable software architecture in mind.",
    ...
    },
    {
      ...
      description:
        "Continuous improvements, dependable maintenance, and technical assistance.",
