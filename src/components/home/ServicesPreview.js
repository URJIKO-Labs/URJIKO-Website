 ...
 * Highlights 4 core service cards + CTA linking to /services
 */
  ...
  const services = [
    {
      ...
      description:
        "Professional websites and digital experiences that help organizations establish their presence, communicate clearly, and reach their customers.",
    ...
    },
    {
      ...
      description:
        "Digital systems that help businesses manage sales, inventory, customers, operations, and reporting more efficiently.",
    ...
    },
    {
      ...
      description:
        "Software designed around your organization's unique workflows, processes, requirements, and operational challenges.",
    ...
    },
    {
      ...
      description:
        "Intelligent software experiences that use AI, automation, and data to help organizations make better decisions and work more efficiently.",
