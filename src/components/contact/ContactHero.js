...
export function renderContactHero() {
  return `
    <section class="section bg-white" aria-labelledby="contact-hero-title" style="padding-top: clamp(4rem, 8vw, 6rem); padding-bottom: clamp(4rem, 8vw, 6rem); position: relative; overflow: hidden;">
      ...
      <div style="position: absolute; top: 10%; left: 4%; width: 180px; height: 180px; border: 2px solid rgba(96, 165, 250, 0.30); border-radius: 50%; pointer-events: none;"></div>
      ...
      <div style="position: absolute; bottom: 15%; left: 8%; width: 100px; height: 100px; background: rgba(96, 165, 250, 0.18); border-radius: 50%; pointer-events: none;"></div>
      ...
      <div style="position: absolute; top: 40%; left: 50%; transform: translate(-50%, -50%); width: 300px; height: 300px; border: 1.5px solid rgba(96, 165, 250, 0.12); border-radius: 50%; pointer-events: none;"></div>
      ...
      <div style="position: absolute; bottom: 12%; left: 35%; width: 14px; height: 14px; background: rgba(96, 165, 250, 0.30); border-radius: 50%; pointer-events: none;"></div>
